...
//add kwds components start 
    ...
    var kwd1style = 'ul{ overflow:hidden}.kwdWrap{margin:0 auto;width:96%}.kwdWrap li{color:#1dc7ea;font-size:21px;margin:20px 0;text-align:left;float:left;width:100%}.kwdWrap li a{color:#1a1a1a;background:url(images/arrowsmall.png) right center no-repeat;padding:0 50px 0 10px}';
    var kwcounter1 = 1;
    $(".kwd1").click(function(){
      if(kwcounter1==1){
    ...
    var kwd2style = 'ul{overflow:hidden}.kwdWrap2{margin:0 auto;width:96%}.kwdWrap2 li{color:#1dc7ea;font-size:21px;margin:20px 0;text-align:left;float:left;width:100%}.kwdWrap2 li a{color:#1a1a1a;background:url(images/arrowsmall.png) left center no-repeat;padding:0 0 0 40px}';
    var kwcounter2 = 1;
    $(".kwd2").click(function(){
      if(kwcounter2==1){
    ...
    var kwd3style = 'ul{overflow:hidden}.kwdWrap3{margin:0 auto;width:96%}.kwdWrap3 li{color:#1dc7ea;font-size:21px;margin:20px 0;text-align:left;float:left;width:100%}.kwdWrap3 li a{color:#1a1a1a;padding:0 0 0 20px}';
    var kwcounter3 = 1;
    $(".kwd3").click(function(){
      if(kwcounter3==1){
